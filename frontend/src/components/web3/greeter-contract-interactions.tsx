  ...
  return (
    <>
      <div className="flex max-w-[22rem] grow flex-col gap-4">
        <h2 className="text-center font-mono text-gray-400">Salary Smart Contract</h2>
        ...
        <Form {...form}>
          ...
          <Card>
            <CardContent className="pt-6">
              <FormItem>
                <FormLabel className="text-base">Fetched Salary</FormLabel>
                <FormControl>
                  <Input
          ...
          <Card>
            <CardContent className="pt-6">
              ...
              >
                <FormItem>
                  <FormLabel className="text-base">Update Salary</FormLabel>
                  <FormControl>
